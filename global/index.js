...
process.on('exit', code => {
  console.log('process.on exit with code=' + code)
})
// process.on exit with code=0

// 判断javascript运行环境：判断js是在浏览器运行还是在node.js环境运行
console.log(typeof window)
if (typeof window === 'undefined') {
  console.log('目前运行在node.js环境')
} else {
  console.log('目前运行在浏览器环境')
}
...
process = {
  ...
  release:{ 
    name: 'node',
    lts: 'Dubnium',
    sourceUrl: 'https://nodejs.org/download/release/v10.15.0/node-v10.15.0.tar.gz',
    headersUrl: 'https://nodejs.org/download/release/v10.15.0/node-v10.15.0-headers.tar.gz',
    libUrl: 'https://nodejs.org/download/release/v10.15.0/win-x64/node.lib' 
  },
  ...
  env: {
    ...
    COMPUTERNAME: 'PC-20190103DWGF',
    ComSpec: 'C:\\Windows\\system32\\cmd.exe',
    HOMEDRIVE: 'C:',
    HOMEPATH: '\\Users\\Administrator',
    LOCALAPPDATA: 'C:\\Users\\Administrator\\AppData\\Local',
    LOGONSERVER: '\\\\PC-20190103DWGF',
    ...
    USERDOMAIN: 'PC-20190103DWGF',
    USERDOMAIN_ROAMINGPROFILE: 'PC-20190103DWGF',
    USERNAME: 'Administrator',
    USERPROFILE: 'C:\\Users\\Administrator',
    VSCODE_CWD: 'C:\\Users\\Administrator\\AppData\\Local\\Programs\\Microsoft VS Code',
    windir: 'C:\\Windows',
    TERM_PROGRAM: 'vscode',
